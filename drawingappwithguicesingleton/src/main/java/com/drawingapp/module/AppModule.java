...
public class AppModule extends AbstractModule{
	...
	protected void configure() {
		...
		// bind(SquareRequest.class).in(Scopes.SINGLETON); // DrawShape's are equal if DrawShape "in(SINGLETON)"
		bind(SquareRequest.class).in(Scopes.SINGLETON); // DrawShape's are equal regardless of DrawShape "in(SINGLETON)"
	}
